...
if __name__ == "__main__":
    ...
    z_level = 0 # si z_level est un entier, alors il représente l'indice de la couche z
    # si z_level est un flottant, alors il représente la profondeur positive en mètre souhaitée.
